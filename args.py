...
def parcel_extractor():
    ...
    source_path = '../xdataset/schaefer_parcellation/label_fsaverage5/'
...
def params_fn(server_mode='misha', dataset='eegfmri_translation'):
    ...
    params.hemo_adjacency_matrix_dir = '../xdataset/graphs_eegfmri/fmri_'+str(params.n_hemo_parcels)+'_parcels/'
    if params.dataset=='megfmri':   
        params.ele_adjacency_matrix_dir = '../xdataset/graphs_eegfmri/meg_'+str(params.n_ele_parcels)+'_parcels/'   
    elif params.dataset=='eegfmri_translation':   
        params.ele_adjacency_matrix_dir = '../xdataset/graphs_eegfmri/eeg_'+str(params.n_ele_parcels)+'_parcels/'
