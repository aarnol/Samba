...
if __name__ == "__main__":   
    ...
    eeg_data_path = '../xdataset/naturalistic_view_eeg_fmri_seconds_'+str(n)+'/'+eeg_folder+'/'
    fmri_data_path = '../xdataset/naturalistic_view_eeg_fmri_seconds_'+str(n)+'/'+fmri_folder+'/'
    ...
    args.output_key = time.strftime(args.model+"--"+args.save_prefix+"--%Y%m%d-%H%M%S--n" + str(n) + args.dataset) 
    print_gpu_info(args)  
